...
public class DetailPageOneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_detail_page_one, container, false);
    ...
    String getXmlDataSchedule(int WEEK_TAG){
        ...
        String queryUrl = "http://openapi.seoul.go.kr:8088/4162636246677573353243664d6e59/xml/SearchSTNTimeTableByIDService/1/1000/"+ STATION_CD +"/"+ WEEK_TAG +"/1/" ;
